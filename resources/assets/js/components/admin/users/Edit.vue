        ...
        <div class="col-md-12 grid-margin">
          <div class="d-flex justify-content-between flex-wrap">
            <div class=" align-items-end flex-wrap">
              <view-navigation :list="'users_edit'"></view-navigation>
              <div class="mr-md-3 mr-xl-5">
                <h2>Editar Usuario [ {{ name }} ]</h2>
                <p class="mb-md-0 p-description-module">Formulario para la <b>Edición</b> de un <b>Usuario</b></p>
              </div>                  
            </div>                
          </div>
        </div>
            ...
            <form class="forms-sample">       
              <div class="row">                
                <div class="form-group col-md-4">
                  <label for="">Rut</label>
                  <span class="mdi mdi-alert-circle circle-info" title="El Rut del Usuario no puede ser editado"></span>
    ...
    export default {
        ...
        data () {
            return {
                ...
                sub_title    : "Formulario para la edición de un Usuario",         
                errors       : {},
                region_list  : {},
                commune_list : {},
                area_list    : {},
        ...
        methods: {
            getUser () {
                var self = this
                this.$http.get('/get-user', {params: {id: self.id}})
                .then(response => {                    
                    ...
                    self.area_id    = response.body.area_id
                    self.profile_id = response.body.profile_id
