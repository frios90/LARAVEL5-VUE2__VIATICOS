      ...
      <div class="col-md-12 grid-margin">
        <div class="d-flex justify-content-between flex-wrap">
          <div class="align-items-end flex-wrap">
            <view-navigation :list="'request_manage_apply'"></view-navigation>            

            <div class="mr-md-3 mr-xl-5">
              <h2>Gestionar la Solicitud [{{folio}}]</h2>
              <p class="mb-md-0 p-description-module">Panel para el <b>Ingreso</b> y <b>Asociación</b> de <b>Gastos</b> a una <b>Solicitud</b></p>
            </div>  
          </div>                
        </div>
      </div>
